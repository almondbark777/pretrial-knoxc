...
func TestConsoleRecordParity(t *testing.T) {
	...
	rec := consoleRecord(c, cases, adminTrack, ci, ptr, gps, models.DefendantExtras{}, db.Ledger{}, nil, "")
...
func TestConsoleRecordDrugScreens(t *testing.T) {
	...
	rec := consoleRecord(c, []*compute.Client{c}, track, ci, ptr, gps, extras, db.Ledger{}, nil, "")
